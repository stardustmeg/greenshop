...
export const SERVER_MESSAGE: Record<LanguageChoiceType, Record<string, string>> = {
  en: {
    ...
    SUCCESSFUL_COPY_PROMO_CODE_TO_CLIPBOARD: 'Promo code has been copied to clipboard',
  ...
  ru: {
    ...
    SUCCESSFUL_COPY_PROMO_CODE_TO_CLIPBOARD: 'Промо-код скопирован в буфер обмена',
